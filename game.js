...
function dialouge1(dialnum) {
  ...
  switch(dialnum) {
    ...
    case 9:
      dial.textContent = 'OoO\n저 버튼은 체력이 많아 보여요! 여러 번 클릭해야 할 것 같네요...'
      break;
    ...
    case 11:
      dial.textContent = 'OoO\n저 버튼은 방패버튼이에요! 방패가 없을 때 클릭해야 해요!'
      break;
    ...
    case 13:
      dial.textContent = 'OoO\n저 버튼은 텔레포트버튼이에요! 클릭하면 자꾸 어디론가 이동하는 얄미운 버튼이죠...'
      break;
